...
function set_banner
{
	...
	echo
	echo -e "${TEXT_VALID} [i] [Package]: crackle${TEXT_RESET}"
...
## ----------------------------
echo -e " Crackle is not yet compiled."
...
then
	...
	echo -e " Please wait while compiling Crackle ...${TEXT_RESET}"
	sleep 5s
	...
	echo
	echo -e " ${TEXT_VALID}[i]${TEXT_RESET} Crackle has been compiled successfully${TEXT_RESET}"
	echo -e " ${TEXT_VALID}[i]${TEXT_RESET} Close this terminal windows and re-open Crackle"
	echo -e "\n"
else
	echo
