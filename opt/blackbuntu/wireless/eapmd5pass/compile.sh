...
function set_banner
{
	...
	echo
	echo -e "${TEXT_VALID} [i] [Package]: eapmd5pass${TEXT_RESET}"
...
## ----------------------------
echo -e " EapMd5pass is not yet compiled."
...
then
	...
	echo -e " Please wait while compiling EapMd5pass ..."
	sleep 5s
	...
	echo
	echo -e " ${TEXT_VALID}[i]${TEXT_RESET} EapMd5pass has been compiled successfully"
	echo -e " ${TEXT_VALID}[i]${TEXT_RESET} Close this terminal and re-open EapMd5pass"
	echo -e "\n"
else
	echo
