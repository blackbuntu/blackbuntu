...
function set_banner
{
	...
	echo
	echo -e "${TEXT_VALID} [i] [Package]: cowpatty${TEXT_RESET}"
...
## ----------------------------
echo -e " CowPatty is not yet compiled."
...
then
	...
	echo -e " Please wait while compiling CowPatty ...${TEXT_RESET}"
	sleep 5s
	...
	echo -e " ${TEXT_VALID}[i]${TEXT_RESET} CowPatty has been compiled successfully${TEXT_RESET}"
	echo -e " ${TEXT_VALID}[i]${TEXT_RESET} Close this terminal windows and re-open CowPatty"
	echo -e "\n"
else
	echo
