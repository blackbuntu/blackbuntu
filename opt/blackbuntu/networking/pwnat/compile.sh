...
function set_banner
{
	...
	echo
	echo -e "${TEXT_VALID} [i] [Package]: pwnat${TEXT_RESET}"
...
## ----------------------------
echo -e " Pwnat is not yet compiled."
...
then
	...
	echo -e " Please wait while compiling Pwnat ...${TEXT_RESET}"
	sleep 5s
	...
	echo
	echo -e " ${TEXT_VALID}[i]${TEXT_RESET} Pwnat has been compiled successfully${TEXT_RESET}"
