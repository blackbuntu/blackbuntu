...
then
	...
	echo -e " Please wait while compiling Intrace ..."
	sleep 5s
	...
	echo
	echo -e " ${TEXT_VALID}[i]${TEXT_RESET} Intrace has been compiled successfully"
	echo -e " ${TEXT_VALID}[i]${TEXT_RESET} Close this terminal and re-open Intrace"
	echo -e "\n"
else
	echo
