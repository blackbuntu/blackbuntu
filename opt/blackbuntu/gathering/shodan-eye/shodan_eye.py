...
def showdam():
    ...
    try:
        ...
        api.search("b00m")
        print ("[v] API Key Authentication: SUCCESS..!")
        time.sleep(0.5)
        ...
        for banner in api.search_cursor(b00m):
            ...
            print ("\n[v] Result: %s. Search query: %s" % (str(counter), str(b00m)))
            time.sleep(0.1)
            print ("+" * 60 + "\n")
