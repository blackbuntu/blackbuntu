...
function set_banner
{
	...
	echo
	echo -e "${TEXT_VALID} [i] [Package]: ohrwurm${TEXT_RESET}"
...
## ----------------------------
echo -e " Ohrwurm is not yet compiled."
...
then
	...
	echo -e " Please wait while compiling Ohrwurm ...${TEXT_RESET}"
	sleep 5s

	sudo rm -f /usr/bin/ohrwurm
