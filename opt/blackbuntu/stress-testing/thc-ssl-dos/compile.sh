...
function set_banner
{
	...
	echo
	echo -e "${TEXT_VALID} [i] [Package]: thc-ssl-dos${TEXT_RESET}"
...
## ----------------------------
echo -e " THC SSL-Dos is not yet compiled."
...
then
	...
	echo -e " Please wait while compiling THC SSL-Dos ...${TEXT_RESET}"
	sleep 5s
	...
	echo
	echo -e " ${TEXT_VALID}[i]${TEXT_RESET} THC SSL-Dos has been compiled successfully${TEXT_RESET}"
