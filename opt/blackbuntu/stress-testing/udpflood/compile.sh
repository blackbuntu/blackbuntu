...
function set_banner
{
	...
	echo
	echo -e "${TEXT_VALID} [i] [Package]: udpflood${TEXT_RESET}"
...
## ----------------------------
echo -e " UdpFlood is not yet compiled."
...
then
	...
	echo -e " Please wait while compiling UdpFlood ...${TEXT_RESET}"
	sleep 5s
	...
	echo -e " ${TEXT_VALID}[i]${TEXT_RESET} UdpFlood has been compiled successfully${TEXT_RESET}"
