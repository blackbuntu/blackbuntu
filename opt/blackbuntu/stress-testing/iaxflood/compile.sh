...
function set_banner
{
	...
	echo
	echo -e "${TEXT_VALID} [i] [Package]: iaxflood${TEXT_RESET}"
...
## ----------------------------
echo -e " IaxFlood is not yet compiled."
...
then
	...
	echo -e " Please wait while compiling IaxFlood ...${TEXT_RESET}"
	sleep 5s
	...
	echo
	echo -e " ${TEXT_VALID}[i]${TEXT_RESET} IaxFlood has been compiled successfully${TEXT_RESET}"
	echo -e " ${TEXT_VALID}[i]${TEXT_RESET} Close this terminal windows and re-open IaxFlood"
	echo -e "\n"
else
	echo
