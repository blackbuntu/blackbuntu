...
function set_banner
{
	...
	echo
	echo -e "${TEXT_VALID} [i] [Package]: inviteflood${TEXT_RESET}"
...
## ----------------------------
echo -e " InviteFlood is not yet compiled."
...
then
	...
	echo -e " Please wait while compiling InviteFlood ...${TEXT_RESET}"
	sleep 5s
	...
	echo -e " ${TEXT_VALID}[i]${TEXT_RESET} InviteFlood has been compiled successfully${TEXT_RESET}"
	echo -e " ${TEXT_VALID}[i]${TEXT_RESET} Close this terminal windows and re-open InviteFlood"
	echo -e "\n"
else
	echo
