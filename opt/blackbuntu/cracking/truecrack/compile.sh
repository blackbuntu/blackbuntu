...
then
	...
	echo -e " Please wait while compiling Truecrack ..."
	sleep 5s
	...
	echo
	echo -e " ${TEXT_VALID}[i]${TEXT_RESET} Truecrack has been compiled successfully"
	echo -e " ${TEXT_VALID}[i]${TEXT_RESET} Close this terminal and re-open Truecrack"
	echo -e "\n"
else
	echo
