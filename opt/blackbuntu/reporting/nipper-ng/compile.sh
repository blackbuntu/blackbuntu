...
then
	...
	echo -e " Please wait while compiling Nipper-NG ..."
	sleep 5s
	...
	echo
	echo -e " ${TEXT_VALID}[i]${TEXT_RESET} Nipper-NG has been compiled successfully"
	echo -e " ${TEXT_VALID}[i]${TEXT_RESET} Close this terminal and re-open Nipper-NG"
	echo -e "\n"
else
	echo
